...
@RestController
@RequestMapping("${app.api.prefix}/v1/customers")
...
public class CustomerRestController {
    ...
    @GetMapping()
    public ApiResponseWrapper<Page<CustomerResponseDTO>> getAllCustomers(
        ...
        return new ApiResponseWrapper<>(customerService.getAllCustomers(customerFilter, page, sort));
    }
    ...
    @GetMapping("/{id}")
    public ApiResponseWrapper<CustomerResponseDTO> getCustomerById(@PathVariable Long id) {
        return new ApiResponseWrapper<>(customerService.getCustomerById(id));
    }
    ...
    @PostMapping()
    public ApiResponseWrapper<CustomerResponseDTO> createCustomer(@RequestBody @Valid CustomerRequestDTO dto) {
        return new ApiResponseWrapper<>(customerService.createCustomer(dto));
    }
    ...
    @PutMapping("/{id}")
    public ApiResponseWrapper<CustomerResponseDTO> updateCustomerById(@PathVariable Long id, @RequestBody @Valid UpdateCustomerRequestDTO dto) {
        return new ApiResponseWrapper<>(customerService.updateCustomerById(id, dto));
    }
    ...
    public ApiResponseWrapper<Page<QuoteSummaryDTO>> getCustomerQuotes(
        ...
        return new ApiResponseWrapper<>(
                customerService.quotesPerCustomer(id, pageFilterRequest, sortFilterRequest, filterRequest));
    }
}
